...
const app = express();
const https = require("https"); // tu línea original
const path = require("path");

// TODO: configure the express server
app.use(express.static(path.join(__dirname, "public"))); // servir CSS, imágenes, etc.
...
// Texto largo (lo dejamos aquí para usarlo si quieres mostrar un post de ejemplo)
const longContent =
...
app.get("/home", (req, res) => {
  if (!name) return res.redirect("/"); // si se pierde el nombre, volver al index
